...
#pragma mark - UIStoryBoard Category
@interface UIStoryboard (GetMainStoryBoard)
+ (instancetype)mainStoryBoard;
@end

@implementation UIStoryboard (GetMainStoryBoard)

static UIStoryboard *_sharedMainStoryBoard = nil;
...
+ (instancetype)mainStoryBoard
{
    ...
    dispatch_once(&onceToken, ^{
        ...
        NSString *mainStoryBoardName = [bundle objectForInfoDictionaryKey:@"UIMainStoryboardFile"];
        _sharedMainStoryBoard = [UIStoryboard storyboardWithName:mainStoryBoardName bundle:bundle];
    });
    return _sharedMainStoryBoard;
}
